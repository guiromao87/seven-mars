...
public class PlateauLimitMoveValidationTest {
    ...
    @Test
    public void shouldNotBeInsideThePlateauStartingAt1And5andNorthAndMovingForwardOnce() {
        Probe probe = new Probe(new Position(1,5), Direction.N, "probe1");
        probe.forward();
    ...
    @Test
    public void shouldNotBeInsideThePlateauStartingAt3And1andEastAndMovingForwardThreeTimes() {
        Probe probe = new Probe(new Position(3,1), Direction.E, "probe1");
        probe.forward();
        probe.forward();
        probe.forward();
